    ...
    <div className="min-h-screen bg-(--bg) text-(--text)">
      <div className="mx-auto flex min-h-screen max-w-[1600px]">
        <aside className="hidden w-72 shrink-0 border-r border-white/6 bg-(--sidebar) px-4 py-5 lg:flex lg:flex-col">
          <div className="animate-fade-up flex items-center justify-center pt-2 pb-2">
            <div className="relative w-full h-20 overflow-visible">
              <Image src="/logo_wide.png" alt="TransitOps" fill className="object-contain scale-150" unoptimized priority />
            </div>
          </div>
