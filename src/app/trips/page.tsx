        ...
        <Panel title="Trip draft board" subtitle="In the database-backed version this will validate capacity, driver status, and vehicle availability before dispatch.">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-white/8 bg-white/6 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-(--muted)">Source</p>
              <p className="mt-2 text-sm text-white">Northbridge Depot</p>
            </div>
            <div className="rounded-2xl border border-white/8 bg-white/6 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-(--muted)">Destination</p>
            ...
            <div className="rounded-2xl border border-white/8 bg-white/6 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-(--muted)">Driver</p>
              <p className="mt-2 text-sm text-white">Available, valid license only</p>
            </div>
            <div className="rounded-2xl border border-white/8 bg-white/6 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-(--muted)">Cargo weight</p>
              <p className="mt-2 text-sm text-white">450 kg</p>
            </div>
            <div className="rounded-2xl border border-white/8 bg-white/6 p-4">
              <p className="text-xs uppercase tracking-[0.24em] text-(--muted)">Distance</p>
